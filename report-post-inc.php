...
if (isset($_POST['submit'])) {
    ...
    $postr = mysqli_real_escape_string($conn, $_POST['reportText']);
    ...
    if (empty($text) || empty($subject)) {
        ...
        $sql = "INSERT INTO bugreport (postr_author, postr_email, postr_subject, postr_text, postr_post) VALUES ('$name', '$email', '$subject', '$text', '$postr');";
...
elseif (isset($_POST['delete'])) {
    ...
    $sql = "DELETE FROM bugreport WHERE postr_id='$reportId'";
    $result = mysqli_query($conn, $sql);
