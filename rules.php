...
<html>
	...
	<body>
    	...
    	<!-- Page -->
            ...
            <h2>3. Copyrights</h2>
            <p>If your reference isn't your own, please credit the real author (use a link if possible or a name/username).</p>
            <p>Please give credits to the author for images you use for the respect of his work and please understand that if an author of any image asks to take away one image, we will do so and ask for you to find a replacement.</p>
            ...
            <p>Please report any bugs encountered, so that we may fix it as soon as possible.</p>
            <p>If you wanna participate in it's developpement please contact us (manga.animes.website@gmail.com).</p>

            <h2>6. Contact</h2>
            <p>Please do not abuse of the contact system, once sent it may take a while for an admin to see it (maximum 72H).</p>

            <h2>7. Multiple accounts</h2>
            <p>Please do not make double accounts, if you lost yours then you may do so but only to contact us (normally you should be able to get it back with the "forget username or password ?").</p>
