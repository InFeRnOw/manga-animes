		...
		<div class="container-fluid">
          ...
          <div class="page">
                <h1>Post Reports</h1>
                    ...
                    <form id="reportForm" action="INCLUDES/report-post-inc.php" method="POST">
                        <div style>
													<div class="row">
	                            ...
	                            <dl class="unit">
	                                ...
	                                <dd>
	                                <input type="text" name="reportSubject" size="30" maxlength="64"/>
	                                </dd>
	                            </dl>
														</div>
													</div>
	                            ...
	                            <dl class="unit">
	                                ...
	                                <dd>
	                                <i>Describe the issue here. (500 Characters max)</i> </br>
	                            		<textarea id="reportText" name="reportText" style="width: 100%; resize: vertical; min-height: 150px; border-radius: 5px; box-shadow: 1px 1px 3px #555; border: 1px solid lightgrey;" maxlength="500"></textarea>   </dd>
	                            </dl>
														</div>
														<div class="col-md-4"></div>
													</div>
