...
<?php if (isset($_GET['recover'])) {
  ...
  $username = $_GET['username'];
			...
			<form action='INCLUDES/recover-inc.php' method='POST'>
				<div id='recoverForm' class='container-fluid'>
				<div class='row'>
				<div class='col-lg-6 col-xs-12'><input style='width: 100%; margin-left: 0;' class='newPassword' type='password' name='newpass' placeholder='New password...'></div>
        <div class='col-lg-6 col-xs-12'><input style='width: 100%; margin-left: 0;' class='newPasswordConfirm' type='password' name='newpassconfirm' placeholder='Confirm new password...'></div>
        <input type="hidden" name="key" value="<? echo $key ?>">
        <input type="hidden" name="username" value="<? echo $username ?>">
					<div class='col-lg-12 col-xs-12'>
					<button style='margin-left: 0px; margin-top:5px; margin-bottom: 5px;' class='button' type='submit' name='submit'>Submit changes</button>
						</div>
					</div>
				</div>
			</form>
