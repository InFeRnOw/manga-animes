...
session_start();
    ...
    if (!empty($_GET['letter'])) {
      $letter = $_GET['letter'];
      $sql = "SELECT * FROM posts WHERE p_active=1 AND p_title LIKE '$letter%'";
    ...
    function display($result) {
      while($row = mysqli_fetch_assoc($result)) {
           ...
           <div class='row'>
                  <div class='col-lg-4 col-md-4 col-sm-12 col-xs-12'><a href='post.php?link=".$row['p_link']."'><h3 style='color: rgba(0,0,0,0.7);'>" .$row['p_title']. "</h3></a></div>
