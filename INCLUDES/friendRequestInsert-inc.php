...
session_start();
    ...
    while($row = mysqli_fetch_assoc($result)) {
         ...
         <div class='container-fluid'>
          ...
          <div class='col-lg-2 col-sm-2 col-xs-2'><button type='submit' name='acceptRequest' style='width: 2em !important; height: 2.8em; margin-top: 0.05em; border-radius: 50%; background-color: #37c0fb; color: white;'>+</button></div>
