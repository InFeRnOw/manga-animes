...
if (isset($_GET['more'])) {
    ...
    $sql = "SELECT * FROM posts WHERE p_active = 1 AND p_user = '$user' ORDER BY p_id ASC LIMIT 3";
    $result = mysqli_query($conn, $sql);
}
...
while ($row = mysqli_fetch_assoc($result)) {
    ...
    echo '<div class="container col-md-4">
              <a href="post.php?link=' . $link . '"><img src="uploads/postsimages/postimg' . $link . '.jpg" alt="Snow" style="width:100%; box-shadow: 1px 1px 12px grey; border-radius: 10px; max-width: 624.33px; max-height: 206.36px;"></a>
